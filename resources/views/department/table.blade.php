    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="pull-right">
                <a href="{{route('department_form')}}" class="btn btn-sm btn-success">
                    <span class="fa fa-plus"></span> Tambah Department
                </a>
...
<script type="text/javascript">
    function edit(sid){
        location.href="{{route('department_edit')}}?id="+sid;
    }
    function deleted(sid){       
      var url   = "{{route('delete') }}?id="+sid+"&table=tb_department&refresh=department";
