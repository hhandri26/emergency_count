    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box-header with-border">
                <div class="row">
                    <div class="col-md-12"><h4 class="box-title"> @if($id>0) Edit Contractor @else Form Tambah Contractor @endif</h4></div>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-6">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="title" class="col-sm-3 control-label1">Contractor ID</label>
                    <div class="col-sm-9">
...
<script>
     function SaveWarning(){
        ...
        a.reason        = $('#reason').val();
        var url         = "{{route('contractor_add') }}?id="+id+"&data="+'['+JSON.stringify(a)+']';
